...
const RidePopUp = (props) => {
    ...
    // Validate props and notify if required data is missing
    if (!props.ride?.pickup || !props.ride?.destination || !props.ride?.fare || !props.ride?.user) {
        toast.error('Required ride information is incomplete!');
        return null;
    }
