...
const ConfirmRide = (props) => {
    const handleConfirm = () => {
        if (!props.pickup) {
            toast.error('Pickup location is missing!');
            return;
        }
        ...
        if (!props.vehicleType || !props.fare[props.vehicleType]) {
            toast.error('Invalid vehicle selection or fare missing!');
            return;
        }
    ...
    return (
        <div>
            ...
            <div className='flex gap-2 justify-between flex-col items-center'>
                ...
                <div className='w-full mt-5'>
                    <div className='flex items-center gap-5 p-3 border-b-2'>
                        ...
                        <div>
                            ...
                            <p className='text-sm -mt-1 text-gray-600'>{props.pickup || 'Not specified'}</p>
                        </div>
                    </div>
                    <div className='flex items-center gap-5 p-3 border-b-2'>
                        ...
                        <div>
                            ...
                            <p className='text-sm -mt-1 text-gray-600'>{props.destination || 'Not specified'}</p>
                        </div>
                    </div>
                ...
                <button onClick={handleConfirm} className='w-full mt-5 bg-green-600 text-white font-semibold p-2 rounded-lg'>
                    Confirm
                </button>
            </div>
        </div>
